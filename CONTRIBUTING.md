...
| Requirement | Why |
| --- | --- |
| [Oracle GraalVM 25.0.4](https://www.graalvm.org/) (`sdk install java 25.0.4-graal`) | The only JDK shipping the Wasm backend and the browser interop module |
...
5. Use [Conventional Commits](https://www.conventionalcommits.org/) (`fix:`, `feat:`, `docs:`,
   `test:`, `ci:`, `chore:`…).
