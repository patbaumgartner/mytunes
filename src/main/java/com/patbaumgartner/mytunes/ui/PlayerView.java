...
final class PlayerView {
	...
	JSObject categoryHeading(String category) {
		JSObject heading = this.dom.createWithClass("li", "station-menu__category");
		this.dom.attribute(heading, "role", "presentation");
		this.dom.text(heading, category);
		return heading;
	}
