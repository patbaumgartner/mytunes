...
public final class AudioElement {
	...
	public AudioElement(Dom dom) {
		...
		// No crossOrigin attribute: plain playback needs no CORS mode, and requesting
		// it makes some Icecast hosts reject the request outright.
	...
	public void loop(boolean value) {
		Js.set(this.element, "loop", value);
	}
