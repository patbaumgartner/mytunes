...
class ArchitectureTests {
	...
	void architectureRulesHold() {
		...
		Taikai taikai = Taikai.builder()
			...
			// which understands the declared module boundaries and is the stronger check.
			// Taikai's variant requires a namespace, and a namespace cannot be combined
			// with the filtered class import that keeps generated AOT output out of
			// these rules.
